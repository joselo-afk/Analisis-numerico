#C�digo del Reto #3
#Realizado por...Juan Pablo Amorocho, Nicolas P�rez Fonseca, Jose Alejandro Lopez Garcia y
...
#	C�digo Runge-Kutta modificado para Sistemas de Ecuaciones.
# Conceptos obtenidos de:
#  http://en.wikipedia.org/wiki/Runge-Kutta_methods
#  http://www.cms.livjm.ac.uk/etchells/notes/ma200/2ndodes.pdf
#
#	El c�digo fue modificado para cumplir con las especificaciones de este proyecto.
# Es funcional para cinco variables incognitas en un sistema de ecuaci�n.
...
#C�digo Adam Bashford WIP.

adambashfordVector <- function(f1, f2, f3, h, v1, v2, v3, v4, v5, k, tf)
{
  #En bashford, recibimos vectores de tama�o 4 para cada variable.
  #Orden debe de ser, Posici�n 4 es el mas reciente o V0, Posici�n 1 el mas antiguo o V-3
  lplot <- c()
  nplot  <- c()
  bplot  <- c()
  ucplot <- c()
  ...
  cat("Esperanza con resultados en Runge-Kutta: ", f1(lplot[1],nplot[1],ucplot[1],uxplot[1],h), "\n")
  cat("Varianza con resultados en Runge-Kutta: ", f2(lplot[1],nplot[1],bplot[1],ucplot[1],uxplot[1],h),"\n")
  cat("Auto-Lag-1 con resultados en Runge-Kutta: ", f3(lplot[1],nplot[1],bplot[1],ucplot[1],uxplot[1],h,1),"\n")
  cat("Auto-Lag-2 con resultados en Runge-Kutta: ", f3(lplot[1],nplot[1],bplot[1],ucplot[1],uxplot[1],h,2),"\n") 
  cat("Auto-Lag-3 con resultados en Runge-Kutta: ", f3(lplot[1],nplot[1],bplot[1],ucplot[1],uxplot[1],h,3),"\n")

}


#Primer M�todo de Resoluci�n de Sistemas de Ecuaciones.
#Se usa Runge-Kutta Orden 4 como primer m�todo.
